...
var wsStart = function (_a) {
    ...
    var getMessageData = function () {
        var len = (data === null || data === void 0 ? void 0 : data.length) || 0;
        return (data === null || data === void 0 ? void 0 : data[Math.floor(Math.random() * len) % len]) || '';
    };
